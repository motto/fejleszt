...
//LANG::RET($szo,$param=[])
$lang_tomb=[
'DATA_CHANGED'=>'Az adatok megváltoztak!',
'DATA ERROR,REPEAT'=> 'Adatbázis hiba, kérem ismételje meg a műveletet!',
'NO DELJOG'=> 'Nincs törlési jog',
'NO PUBJOG'=> 'Nincs publikálási jog',
'NO UNPUBJOG'=> 'Nincs unpublikálási jog',
'NO EDITJOG'=> 'Nincs szerkesztési jog',
'NO MAKEJOG'=> 'Nincs létrehozási jog',
'USER DATA CHANGE'=> 'Felhasználói adatok változtatatása',
'REG SUCCESFULL'=>'A regisztráció sikeres',
'HI'=>'Üdv',
'EMAIL'=>'Email',
'SAVE'=>'Mentés',
'USER NAME'=>'Felhasználó név',
'ERR_PASSWD'=>'Hibás felhasználónév vagy jelszó',
'USER'=>'Felhasználó',
'PASSWD'=>'Jelszó',
'NEW PASSWD'=>'Új jelszó',
'REPEAT'=>'mégegyszer', //jelszó mégegyszer
...
'R_MIN_MAX'=>'A <<0>> minimum <<1>> maximum <<2>>  karakter hosszú lehet!',//változók 
