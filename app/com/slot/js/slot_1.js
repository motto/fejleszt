...
var RUNTIME = 250; // how long all slots spin before starting countdown
var SPINTIME = 250; // how long each slot spins at minimum
...
Game.prototype.update = function() {
	...
	$('#results').show();
	var kepnev1 =that.items1[that.result1].id; 
	var csop1 = kepnev1.charAt(0)
	var kepnev2 =that.items2[that.result2].id; 
	var csop2 = kepnev1.charAt(0)
	var kepnev3 =that.items3[that.result3].id; 
	var csop3 = kepnev1.charAt(0)
